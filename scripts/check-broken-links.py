#!/usr/bin/env python3
"""
check-broken-links.py — 知识库链接完整性回归测试（内容平铺在仓库根）
...
def main():
    parser = argparse.ArgumentParser(description='知识库链接完整性回归测试')
