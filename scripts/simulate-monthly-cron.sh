...
ROOT = '12.interview'
STORIES_ROOT = '13.story'
MAIN_MODULES = ['01.java-and-jvm', '02.cs-foundations', '03.data-stack',
               '04.spring-backend', '05.frontend', '06.distributed-systems',
               '07.devops-and-tools', '08.ai-foundations', '09.ai-applications',
               '10.business-systems', '11.product-and-pm']
