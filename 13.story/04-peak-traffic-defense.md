...
- [咬文嚼字·seckill-without-redis 面试题](../12.interview/04.system-design/seckill-without-redis/README.md) — 5 题配套面试（含 30/60 秒话术 + 踩分点）
...
- 风控业务建模面试：[砍一刀算法面试深挖](../12.interview/04.system-design/砍一刀算法/README.md) — 4 道风控面试题（K-Factor / 业务建模 / 风控架构 / 黑产对抗）
