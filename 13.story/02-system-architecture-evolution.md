...
> 🆕 **4 模式深度解析**：ReAct Thought/Action/Observation + Plan-and-Execute 3 大重规划 + 4 模式 6 维量化对比 + 5 分钟决策树 → 详见 [Agent 4 大执行模式深度专题](../09.ai-applications/agent/agent-execution-patterns/README.md)（含 5 文件 1107 行）。面试精选 7 道 Q&A 见 [12.interview/11.ai/react-vs-plan-execute](../12.interview/11.ai/react-vs-plan-execute/README.md)。
