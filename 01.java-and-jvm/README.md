...
- 下游：[`06.spring`](../04.spring-backend/) — Spring 生态（Java 最主流框架）
- 关联：[`06.distributed-systems`](../06.distributed-systems/README.md) — 系统设计（Java 工程实践的上层方法论）
- 面试：[`13.split-hairs/01.java`](../12.interview/01.java/README.md) — 41 篇 Java 高频面试题
...
| 配套面试题 | 41 篇 | `note/12.interview/01.java/` 下 leaf 文章数（2026-09-15 find 校对） |
